...
4. Desplegar **Streamlit** y **Reflex** con `COMPUTE_API_URL` y `DJANGO_ADMIN_BASE_URL`; luego cruzar URLs: `STREAMLIT_LAB_URL` en Reflex y `PORTAL_REFLEX_URL` en Streamlit (ver [`deploy-free-tier.md`](deploy-free-tier.md)).
