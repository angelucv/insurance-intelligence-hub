...
| `DJANGO_ADMIN_BASE_URL` | Streamlit (opcional) | Base URL del Admin para enlace a `/admin/upload-policies/`. |
...
4. Desplegar **Streamlit Cloud** y **Reflex Cloud** (o contenedor) con `COMPUTE_API_URL` y, si quieres, `DJANGO_ADMIN_BASE_URL` en secretos Streamlit.
